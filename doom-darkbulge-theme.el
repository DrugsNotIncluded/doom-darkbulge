;;; doom-darkbulge-theme.el --- Atom's flatwhite theme with altered color palette, uses fruvbox as a base -*- lexical-binding: t; no-byte-compile: t; -*-
...
(defgroup doom-darkbulge-theme nil
  "Options for the `doom-darkbulge' theme."
  :group 'doom-themes)

(defcustom doom-darkbulge-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-darkbulge-theme
  :type 'boolean)

(defcustom doom-darkbulge-no-highlight-variables nil
...
(def-doom-theme doom-darkbulge
  "A minimal light syntax theme"

  ;; name        default   256       16
  (
   (fw-base1           '("#fbf1c7" "#666666" "black"))
   (fw-base2           '("#504945" "#999966" "brightblack"))
   (fw-base3           '("#b9a992" "#cc9999" "brightblack"))
   (fw-base4           '("#7c6f64" "#cccccc" "brightblack"))
   (fw-base5           '("#928374" "#cccccc" "brightblack"))
   (fw-base6           '("#1d2021" "#ffffcc" "brightblack"))
   (fw-base7           '("#282828" "#ffffff" "brightblack"))
   ...
   (fw-orange-blend    '("#fe8019" "#ffcccc" "brightorange"))
   ...
   (fw-teal-blend      '("#304640" "#ccffcc" "brightcyan"))
   ...
   (fw-purple-blend    '("#934268" "#ffccff" "brightpurple"))
   ...
   ;; custom categories
   (-modeline-bright doom-darkbulge-brighter-modeline)
   (-no-highlight-variables doom-darkbulge-no-highlight-variables)
   (-modeline-pad
  ...
  ((font-lock-builtin-face :inherit 'italic :foreground fg :extend t)
   ...
   (font-lock-function-name-face        :foreground fg
                                        :weight 'semi-bold)
   (font-lock-keyword-face              :background fw-yellow-muted
                                        :foreground fw-yellow-text
										:overline fw-yellow)
   ...
   (swiper-background-match-face-4 :inherit 'unspecified
                                   ...
                                   :weight 'bold)
   ;;;; nano-modeline
   (nano-modeline-active :foreground fw-base1
						 :background fw-base2
						 :weight 'bold)
...
;;; doom-darkbulge-theme.el ends here
